...
// Otherwise returns -1
int studPokerBetRound(std::vector<Player>& player, std::deque<int> playerOrder,
                      int blind, bool preflop, int& pot, bool isFiveCardStud) {
...
void fiveCardStudPokerGameRound(std::vector<Player>& player,
...
void standardPokerGameRound(std::vector<Player>& player,
                            std::deque<int>& playerOrder, int blind) {
    int playerCount = playerOrder.size();
