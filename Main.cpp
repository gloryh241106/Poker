...
int main() {
    ...
    // Hand hand;
    // hand.add(Suit::SPADES | (Rank::SEVEN << 2));
    // hand.add(Suit::HEARTS | (Rank::FIVE << 2));
    // hand.add(Suit::SPADES | (Rank::SIX << 2));
    // hand.add(Suit::SPADES | (Rank::NINE << 2));
    // hand.add(Suit::CLUBS | (Rank::EIGHT << 2));
    ...
    // hand.add(Suit::SPADES | (Rank::SIX << 2));
    // hand.add(Suit::DIAMONDS | (Rank::FOUR << 2));
    // hand.add(Suit::CLUBS | (Rank::TWO << 2));
    // PokerEngine::eval(hand.bit());
    // std::cout << hand.toString() << std::endl;
    // std::cout << PokerEngine::type(hand) << std::endl;
    return 0;
